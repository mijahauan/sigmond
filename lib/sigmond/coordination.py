...
def render_env(coord: Coordination) -> str:
    """Render the coordination as KEY=VALUE lines suitable for systemd
    EnvironmentFile=.  This is pure — no filesystem access."""
    lines = [
    ...
    # Passthrough any "port" extra on ka9q-web instances — very common need.
    for c in coord.clients:
